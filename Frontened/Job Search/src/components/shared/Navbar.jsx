          ...
          </ul>
          {
            !user ? (
              <div className='flex items-center gap-2'>
                ...
                <Link to="/signup"><Button className="bg-[#6A38C2] hover:bg-[#231a57]">Sign Up</Button></Link>
              </div>
            ) : (
              <Popover>
                    ...
                    <div className='flex flex-col  text-gray-600'>
                      {
                        user && user.role === 'recruiter' ? (
                          ...
                          <>
                            ...
                            <div className='flex w-fit items-center gap-2 cursor-pointer'>
                              <LogOut />
                              <Button onClick={logoutHandler} variant="link" className="border-none">Log Out</Button>
                            </div>
                          </>
                        )
                      }
